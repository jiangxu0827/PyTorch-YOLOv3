...
parser.add_argument("--model_config_path", type=str, default="config/yolov3_train608_anchor.cfg", help="path to model config file")
...
parser.add_argument(
    "--checkpoint_dir", type=str, default="checkpoints/checkpoint_608", help="directory where model checkpoints are saved"
)
...
dataloader = torch.utils.data.DataLoader(
    ListDataset(train_path,opt.img_size), batch_size=opt.batch_size, shuffle=False)
