...
parser.add_argument('--model_config_path', type=str, default='config/yolov3_detect608_anchor.cfg', help='path to model config file')
...
for batch_i, (_, imgs, targets) in enumerate(dataloader):
    ...
    with torch.no_grad():
        output = model(imgs)
        output = non_max_suppression(output, 10, conf_thres=opt.conf_thres, nms_thres=opt.nms_thres)
